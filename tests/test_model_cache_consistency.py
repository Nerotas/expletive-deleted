        ...
        for name, custom, managed_exists, custom_exists, expected_ready in cases:
            with self.subTest(name=name), tempfile.TemporaryDirectory() as temporary:
                ...
                with (
                    ...
                    patch("backend.runtime.dependencies.inspect_executable", return_value=ready),
                    patch("backend.runtime.dependencies.inspect_python_dependencies", return_value=(ready,)),
                    patch("backend.runtime.dependencies.inspect_ytdlp", return_value=ready),
                    patch("backend.runtime.dependencies.inspect_js_runtime", return_value=ready),
