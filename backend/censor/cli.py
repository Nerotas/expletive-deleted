...
from backend.media_identity import publish_output
...
def main():
    ...
    parser.add_argument("--force-transcribe", action="store_true", help="Create a fresh transcript while retaining previous transcript files")
