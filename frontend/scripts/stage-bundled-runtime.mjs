...
if (!suppliedDirectory && runtimeRequired) throw new Error('A packaged release requires BUNDLED_RUNTIME_DIR with an audited runtime payload.')
...
if (!sourceDirectory) {
  console.log('No BUNDLED_RUNTIME_DIR supplied; packaging without a bundled runtime payload.')
  process.exit(0)
}
