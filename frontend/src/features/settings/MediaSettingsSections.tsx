...
type Props = {
  ...
  setGroup: SettingsController['updateGroup']
}

// These controls edit the shared draft; saving and backend validation stay in the controller.
export function MediaSettingsSections({ settings, capabilities, setGroup }: Props) {
  return <>
