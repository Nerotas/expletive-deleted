  ...
  >
    ...
    >
      {view === 'queue' ? <>
        ...
        <button className="icon-button" title="Open Finished / Output folder" aria-label="Open Finished / Output folder" disabled={!settings?.directories.output} onClick={() => settings?.directories.output && void queue.openFolder(settings.directories.output)}>
          <FolderOpen size={18} />
        </button>
