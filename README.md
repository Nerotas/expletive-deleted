...
Version **1.0.12** is the current Windows release.
...
2. Download `Expletive-Deleted-Setup-1.0.12-x64.exe` from the [latest release](https://github.com/Nerotas/expletive-deleted/releases/latest).
