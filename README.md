...
Version **1.2.2** is the current Windows release.
...
1. Download `Expletive-Deleted-Setup-1.2.2-x64.exe` from the [latest release](https://github.com/Nerotas/expletive-deleted/releases/latest).
